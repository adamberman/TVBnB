ActiveRecord::Base.transaction do
	...
	Review.create!(content: "As a man who's in need of a nice place, this is a nice place. Next door neighbor just keeps showing up though.", user_id: 1, listing_id: 1)
	Review.create!(content: "Used to live in the building, really great location. If only I could have afforded to stay in the building...", user_id: 3, listing_id: 1)
	Review.create!(content: "Lots of junk and stuff. Closet is solid. Roommate and I are always adventuring, you're welcome to join us.", user_id: 4, listing_id: 2)
	Review.create!(content: "Grossest, dirtiest, most foul apartment I've ever seen. Roommates are a slob and a homicidal robot. Avoid at all costs.", user_id: 5, listing_id: 2)
	Review.create!(content: "It's an amazing apartment. My sister lives there, and she's a great host. Naked guy lives across the street.", user_id: 7, listing_id: 3)
	Review.create!(content: "This space has soothing vibes, the best friends, and also a very ugly naked man cearly visible through the window.", user_id: 8, listing_id: 3)
	Review.create!(content: "A perfect apartment for a New York third-wave feminist, college-educated, over-scheduled, undersexed, person. You can do better.", user_id: 11, listing_id: 4)
	Review.create!(content: "My best friend's apartment. I wouldn't be caught dead there though. Too many poor people.", user_id: 12, listing_id: 4)
